...
- JavaScript ([Node.js](https://www.npmjs.com/package/decancer)/[Deno](https://deno.land/x/decancer@v1.5.2)/Browser)
...
```ts
import init from "https://deno.land/x/decancer@v1.5.2/mod.ts"
...
```html
<script type="module">
  import init from "https://cdn.jsdelivr.net/gh/null8626/decancer@v1.5.2/decancer.min.js"
