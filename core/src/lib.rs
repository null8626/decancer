...
//! - It stores it's huge collection of confusables in a [customized 18.65 KB binary file](https://github.com/null8626/decancer/blob/main/core/bin/confusables.bin) instead of a huge JSON or text file to optimize it's bundle size!
//! - It supports curing **6,121 different confusables** into cured-lowercased-strings, including:
//!   - Accented characters
