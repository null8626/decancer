...
#define DECANCER_OPTION_PURE_HOMOGLYPH (((1 << 22) - 1) ^ 0x200003)
    ...
    _DECANCER_EXPORT decancer_raw_wide_t decancer_raw_wide(decancer_cured_t cured, uint16_t *const *output_ptr, size_t *output_size);
    ...
    _DECANCER_EXPORT bool decancer_contains(decancer_cured_t cured, uint8_t *other_str, const size_t other_size);_DECANCER_EXPORT bool decancer_contains_wide(decancer_cured_t cured, uint16_t *other_str, const size_t other_size);
    _DECANCER_EXPORT bool decancer_starts_with(decancer_cured_t cured, uint8_t *other_str, const size_t other_size);
    _DECANCER_EXPORT bool decancer_starts_with_wide(decancer_cured_t cured, uint16_t *other_str, const size_t other_size);
