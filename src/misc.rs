...
const MISC: [(&'static [u8], &'static [u16]); 79] = [
  (&[0x30], &[0xDFE2]), // "0"
  (&[0x31], &[0x00B9, 0xDFE3]), // "1"
  (&[0x32], &[0x00B2, 0x01BB, 0x03E9, 0x14BF, 0xA645, 0xA6EF, 0xA75B, 0xDFE4]), // "2"
  (&[0x33], &[0x00B3, 0x018E, 0x01BA, 0x01B7, 0x01EF, 0x021C, 0x021D, 0x025C, 0x0292, 0x0293, 0x0417, 0x0437, 0x044D, 0x0499, 0x04DF, 0x04E0, 0x04E1, 0x04ED, 0x1D08, 0x1D23, 0x1D32, 0x1D4C, 0x2CCC, 0x2CCD, 0xA76A, 0xA76B, 0xDF3B, 0xDFE5]), // "3"
  (&[0x34], &[0x13CE, 0xAB9E, 0xDFE6]), // "4"
  (&[0x35], &[0x01BC, 0x01BD, 0x01BE, 0xDFE7]), // "5"
  (&[0x36], &[0x0431, 0x13EE, 0x2CD3, 0xABBE, 0xDFE8]), // "6"
  (&[0x37], &[0x2138, 0x2801, 0xDFE9]), // "7"
  (&[0x38], &[0x09EA, 0x0A6A, 0x0B03]), // "8"
  (&[0x39], &[0x09ED, 0x0A67, 0x0B68, 0x0D6D, 0x2CCB, 0xA76F, 0xDEDD, 0xDF8B, 0xDFC5, 0xDFEA]), // "9"
  (&[0x61], &[0x039B]), // "a"
  (&[0x64], &[0x00D0]), // "d"
  (&[0x65], &[0x03A3]), // "e"
